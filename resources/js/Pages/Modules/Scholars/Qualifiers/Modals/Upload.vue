            ...
            <BRow>
                <BCol lg="12">
                    ...
                    <div class="text-center">
                        ...
                        <br/>
                        <span v-if="users.length > 0 && isLoading == false" class="text-muted mb-5">Are you sure you want to import the <span class="font-weight-bold text-danger"> {{ users.length }}</span> qualifiers?</span>
                    </div>
                </BCol>
            </BRow>
        </form>
